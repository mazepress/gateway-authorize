# MazePress - Gateway Authorize.Net
...
3. Run `Composer install mazepress/gateway-authorize`
...
```json
{
  ...
  "repositories": [
    {
      "type": "vcs",
      "url": "https://github.com/mazepress/gateway-authorize.git"
    }
  ],
  "require": {
    "mazepress/gateway-authorize": "dev-main"
  },
  "extra": {
    "installer-paths": {
      "packages/{$name}": [
        "mazepress/gateway-authorize"
      ]
    }
  }
}
